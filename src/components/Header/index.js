    ...
    return(
        <nav className="nav-header">
            <div className='nav-content'> 
                ...
                <img className='logo-img' src="https://cdn.theorg.com/fe459660-1022-4417-94be-e2e154ec4fb9_medium.jpg" alt="logo" />
                ...
                <div className='nav-bar-content-2'>
                    <img className='cart-logo-img' src="https://cdn-icons-png.flaticon.com/512/263/263142.png" alt="cart-image" />
